...
function openWhatsAppPopup(e: React.MouseEvent) {
  e.preventDefault();
  const width = 420;
  const height = 640;
...
function DocModal({ docKey, onClose }: { docKey: string | null; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70" onClick={onClose}>
      ...
      >
        ...
        {doc.blocks.map((b: { type: string; text: string }, i: number) =>
          b.type === "h" ? (
    ...
    <div className="min-h-screen bg-[#0a0a0c] text-white" style={{ fontFamily: "'Inter', sans-serif" }}>
      <header className="sticky top-0 z-50 bg-[#0a0a0c]/95 backdrop-blur border-b border-[#1c1c20]">
        <div className="max-w-6xl mx-auto px-6 h-[68px] flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href={WHATSAPP_URL} onClick={openWhatsAppPopup} className="text-sm font-semibold text-[#b8b8bd] hover:text-white px-3 py-2">Contact sales</a>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-4 bg-[#111113] border border-[#232327] rounded-lg px-8 py-6">
          ...
          <a href={WHATSAPP_URL} onClick={openWhatsAppPopup} className="bg-white text-[#0a0a0c] font-bold text-sm px-6 py-3 rounded-md hover:opacity-90 transition-opacity whitespace-nowrap">Contact sales</a>
        </div>
      </section>
