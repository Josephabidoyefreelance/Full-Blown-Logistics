        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-lg rounded-xl bg-white p-6 dark:bg-neutral-900">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Add maintenance</h2>
              <button
            ...
            <form
              ...
              action={(fd) => {
                ...
                startTransition(async () => {
                  const res = await createMaintenanceRecord(fd);
                  if (res?.error) {
                    setError(res.error);
                    return;
                  }
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="mb-1 block text-xs font-medium text-neutral-500">Cost (₦)</label>
                  <input
                    type="number"
                    step="0.01"
                    name="cost"
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-neutral-500">Service date</label>
                  <input
                    type="date"
                    name="service_date"
                    className="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 outline-none focus:border-red-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-neutral-500">Raised by</label>
                <select
                  name="raised_by"
                  defaultValue=""
                  className="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 outline-none focus:border-red-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
              ...
              >
                {isPending ? 'Adding...' : 'Add maintenance'}
              </button>
            </form>
          </div>
        </div>
