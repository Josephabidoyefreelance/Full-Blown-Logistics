...
export default function NewKbForm() {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-lg rounded-xl bg-white p-6 dark:bg-neutral-900">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Add article</h2>
              <button
            ...
            <form
              ...
              action={(fd) => {
                ...
                startTransition(async () => {
                  const res = await createKbArticle(fd);
                  if (res?.error) {
                    setError(res.error);
                    return;
                  }
            ...
            >
              <div>
                ...
                <input
                  name="question"
                  required
                  placeholder="Can I track my shipment?"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  placeholder="Yes. Every shipment gets a JAAD tracking number..."
                  className="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 outline-none focus:border-red-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
                />
              </div>
              <button
